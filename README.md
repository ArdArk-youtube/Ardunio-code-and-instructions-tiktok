...
Next,
  ...
  Finally,
    This is the description for controlling your 4 servos with a Arduino uno and a PCA9685 servo driver board. First before you run the code you need to install the librarys.
